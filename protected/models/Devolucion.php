...
class Devolucion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fecha, hora, idcajero, venta_idventa', 'required'),
			array('idcajero, venta_idventa', 'numerical', 'integerOnly'=>true),
			array('fecha, hora', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('iddevolucion, fecha, hora, idcajero, venta_idventa', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'ventaIdventa' => array(self::BELONGS_TO, 'Venta', 'venta_idventa'),
		);
	}
